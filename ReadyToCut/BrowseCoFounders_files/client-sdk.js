(function (root, factory) {
    ...
    var AppClient = function () {
        _.bindAll(this, "_initializationFilter", "init",
            ...
            "login", "logout", "isUserLoggedIn", "dao", "folder",
            "isOffline", "isOnline",
            "goOffline", "goOnline",
        ...
        var initFilterFunctionsForWrap = [
            "synchronize", "initOnline", "initOffline", "goOffline", "goOnline",
            "retrySync", "resetFailedSync", "revertLocalChanges", "login", "logout",
            "isUserLoggedIn", "dao", "folder", "invoke", "post", "get",
            "getDeferredActions", "saveDeferredActions", "clearCache", "setCustomModel", "removeCustomModel"
        ];

        //wrapping AppClient functions into initialization filter
        for(var i = 0; i< initFilterFunctionsForWrap.length; i++){
            var functionName = initFilterFunctionsForWrap[i];
    ...
    AppClient.prototype.login = function (username, password) {
        ...
        if (this.isOffline()) {
            return Q.fcall(function () {
                return Q.Promise(function (resolve, reject) {
                    var userData = new UserData(username, password, true);
                    var storedUserData = _.find(this._usersData, _.omit(userData, "password"));
            ...
            return this.ajax("POST", this.settings._url.security + "/login", options)
                .then(function (tokenObj) {
                    ...
                    this._usersData = [];
                    this._usersData.push(_.omit(userData, "password"));
                    this._currentUser = userData;
                }.bind(this))
    ...
    AppClient.prototype.isUserLoggedIn = function () {
        return this._currentUser !== null && this._currentUser instanceof UserData;
    }

/**
 * Created by Верстка on 18.05.2017.
 */
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    function addScript( type, code, canvas){
    ...
    var fromDomCanvaces = document.getElementsByClassName('diagrammCanvas');
    var code = ` var center = view.center;
    var radius = 100;
    ...
    var canvacesArr = [];
    for (var i=0;i<fromDomCanvaces.length; i++){
        canvacesArr.push(fromDomCanvaces[i]);
    }
    canvacesArr.forEach(function (item,i) {
        addScript('text/paperscript',code, 'myCanvas'+i);
    });
